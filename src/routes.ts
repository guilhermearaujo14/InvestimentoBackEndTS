...
import AtualizaMovimentacaoController from "./controllers/movimentacoesController/AtualizaMovimentacao";
...
router.put('/AtualizaMovimentacao/:USUARIO_ID', AtualizaMovimentacaoController);
